...
export default function ReportsMasterPage() {
  ...
  const reports = [
    ...
    {
      id: 2,
      name: 'Patient Admission Summary',
      category: 'Clinical',
      lastGenerated: '15 May 2023',
      frequency: 'Weekly',
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Reports Master</h1>
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Reports Master</h2>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredReports.map((report) => (
                  <tr key={report.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${report.status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                        {report.status}
                      </span>
                    </td>
