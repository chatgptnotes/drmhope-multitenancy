...
export default function EsicOverviewPage() {
  // Sample ESIC billing data
  const esicBilling = [
    { 
      id: 'E001', 
      hospital: 'City General Hospital', 
      patient: 'Rahul Sharma', 
      esicId: 'ESI1234567890', 
      date: '2023-05-15', 
      amount: '₹4,500', 
      status: 'Approved' 
    },
  ...
  // Summary statistics
  const summary = [
    { label: 'Total ESIC Billings', value: '487', icon: '📝', color: 'bg-blue-100 text-blue-800' },
    { label: 'Approved Billings', value: '412', icon: '✅', color: 'bg-green-100 text-green-800' },
    { label: 'Pending Review', value: '58', icon: '⏳', color: 'bg-yellow-100 text-yellow-800' },
    { label: 'Rejected Billings', value: '17', icon: '❌', color: 'bg-red-100 text-red-800' },
  ];

  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">ESIC Billing Overview</h1>
        <p className="text-gray-600">Monitor and manage all ESIC billings across hospitals</p>
      </div>
        ...
        <div className="px-6 py-4 border-t">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-600">
              Showing <span className="font-medium">5</span> of <span className="font-medium">487</span> billings
            </div>
            <div className="flex space-x-2">
